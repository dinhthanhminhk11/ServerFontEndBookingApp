...
export class MessageService {
  API = 'https://rough-hill-5837.fly.dev/api/Message'
  ...
  sendMessageDB(data:any):Observable<any>{
    return this.httpRequests.post<any>('https://rough-hill-5837.fly.dev/api/Message/addmsg',data)
  }
  joinRoom(id:any){
  ...
  statusMessage(data:any):Observable<any>{
   return this.httpRequests.post<any>('https://rough-hill-5837.fly.dev/api/Message/statusMessage',data)
  }
  ...
  statusUser(id:String):Observable<any>{
    ...
    return this.httpRequests.put<any>(`https://rough-hill-5837.fly.dev/api/statusUser/${id}`,data)
  }
